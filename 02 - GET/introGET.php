...
if (isset($_GET["cat"])) {
    ...
    else if ($cat == "elec") $categorie = "Electro-Menager";
    else if ($cat == "jrdn") $categorie = "Jardin";
...
<body>
    ...
    <div class="container">
        <?php if ($categorie == null) echo "<h1>Choisissez une catégorie</h1>";
        else echo "<h1>Vous avez choisi la catégorie : $categorie</h1>"; ?>
